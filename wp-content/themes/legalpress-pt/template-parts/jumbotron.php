	...
	<div class="carousel  slide  js-jumbotron-slider" id="headerCarousel" data-ride="carousel" <?php printf( 'data-interval="%s"', get_field( 'auto_cycle' ) ? get_field( 'cycle_interval' ) : 'false' ); ?>>
		...
		<div class="carousel-inner">
			...
			while ( have_rows( 'slides' ) ) :
				...
				$slider_sizes = array( 'legalpress-jumbotron-slider-l', 'legalpress-jumbotron-slider-m', 'legalpress-jumbotron-slider-s' );

				$slide_image_srcset = LegalPressHelpers::get_slide_sizes( get_sub_field( 'slide_image' ), $slider_sizes );
				$slide_link         = get_sub_field( 'slide_link' );

				$slider_src_img = wp_get_attachment_image_src( absint( get_sub_field( 'slide_image' ) ), 'legalpress-jumbotron-slider-s' );
			?>
			...
			<div class="item <?php echo 0 === $i ? ' active' : ''; ?>">
				...
				<div class="container">
					...
					<?php if ( strlen( get_sub_field( 'slide_headline' ) ) ) : ?>
