		...
		makepot: {
			theme: {
				options: {
					...
					include:         [config.phpFileRegex, '^inc/'+config.phpFileRegex, '^inc/widgets/'+config.phpFileRegex, '^woocommerce/'+config.phpFileInSubfolderRegex],
					mainFile:        'style.css',
			...
			proteuswidgets: {
				options: {
					domainPath:      'languages/proteuswidgets/',
					include:         [
						'^vendor/proteusthemes/proteuswidgets/'+config.phpFileRegex,
						'^vendor/proteusthemes/proteuswidgets/inc/'+config.phpFileRegex,
						'^vendor/proteusthemes/proteuswidgets/widgets/'+config.phpFileRegex,
					],
					mainFile:        'vendor/proteusthemes/proteuswidgets/proteuswidgets.php',
					potComments:     'Copyright (C) {year} ProteusThemes \n# This file is distributed under the GPL 2.0.',
