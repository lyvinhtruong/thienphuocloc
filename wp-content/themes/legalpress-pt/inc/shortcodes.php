<?php
/**
 * Shortcodes for LegalPress WP theme defined
 *
 * @package LegalPress
 */
 ...
 * @return string HTML
 */
if ( ! function_exists( 'legalpress_fa_shortcode' ) ) {
	function legalpress_fa_shortcode( $atts ) {
	...
	add_shortcode( 'fa', 'legalpress_fa_shortcode' );
}
 ...
 * @return string HTML
 */
if ( ! function_exists( 'legalpress_button_shortcode' ) ) {
	function legalpress_button_shortcode( $atts, $content = '' ) {
		extract( shortcode_atts( array(
			'style'   => 'primary',
			'href'    => '#',
			'target'  => '_self',
	...
	add_shortcode( 'button', 'legalpress_button_shortcode' );
}