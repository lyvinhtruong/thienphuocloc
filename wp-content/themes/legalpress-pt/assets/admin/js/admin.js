...
LegalPress.Views.Abstract = Backbone.View.extend( {
...
_.extend( LegalPress.Views, {
	// View of a single counter
	Counter: LegalPress.Views.Abstract.extend( {
...
LegalPress.ListViews.Abstract = Backbone.View.extend( {
...
_.extend( LegalPress.ListViews, {
	// Collection of all counters, but associated with each individual widget
	Counters: LegalPress.ListViews.Abstract.extend( {
		events: {
...
_.extend( LegalPress.Utils, {
	...
	repopulateCounters: function ( countersJSON, widgetId ) {
		var parameters = {
			...
			itemsModel:   LegalPress.Models.Counter,
			itemView:     LegalPress.Views.Counter,
		};

		this.repopulateGeneric( LegalPress.ListViews.Counters, parameters, countersJSON, widgetId );
	},
} );